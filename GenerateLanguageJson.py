...
defaultLang = {
    "template": {
        "_comment": "This is a comment. It will be ignored by your program.",
...
languages_folder = os.path.join(current_folder, "languages")
os.makedirs(languages_folder, exist_ok=True)
json_file_path = os.path.join(languages_folder, "languages.json")
with open(json_file_path, "w", encoding="utf-8") as f:
    json.dump(defaultLang, f, ensure_ascii=False, indent=4)
print(f"languages.json created at: {json_file_path}")
